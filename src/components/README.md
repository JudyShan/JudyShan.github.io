...
### `MiscellanyCarousel.astro`

Responsive image carousel used by hobby cards and academic-timeline entries. Supports buttons,
position dots, touch scrolling, reduced motion, and Astro view transitions.

**Props:**

- `images: { src: string; alt: string }[]`
- `title: string` — Included in the accessible gallery label
- `labels: { gallery: string; previous: string; next: string; goTo: string }`
